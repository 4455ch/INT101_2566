...
public class Int101Homework02Updated {
    ...
    public static void main(String[] args) {
     ...
     static void work01Utilitor() {
        System.out.println(Utilitor.testString("Hill"));
        System.out.println(Utilitor.testPositive(300));
        System.out.println(Utilitor.computeIsbn10(998877665));
    ...
    static void work02Person() {
        Person p1 = new Person("chitsanupong", "chomthong");
        Person p2 = new Person("kumamon", "mon");
        Person p3 = new Person("tao", "bin");
        System.out.println(p1);
        System.out.println(p2);
        System.out.println(p3);
        System.out.println(p1.getFirstname());
        p2.setFirstname("hatari");
        p2.setLastname("yen");
    ...
    static void work03Account() {
        Person p1 = new Person("chitsanupong", "chomthong");
        Person p2 = new Person("kumamon", "mon");
        Person p3 = new Person("dentyne", "splash");
