...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
       System.out.println(MyUtil.calculateBMI(88, 1.75));
       System.out.println(MyUtil.average(10, 10, 20));
      /*
   ...
   static void work04UseOfObjectClass() {
       Person Chitsanupong = new Person(20042547);
       System.out.println(Chitsanupong);
       Person hill = new Person(44554455);
       System.out.println(hill);
       BankAccount NEXT = new BankAccount(123456,hill);
